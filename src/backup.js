...
function modeDEmploi(maintenant, contenu) {
  const lignes = [
    ...
    '  Cette archive reste utile : elle porte ce qui n’appartient qu’à ce poste (jetons compris,',
    '  voir plus haut), et elle permet de repartir sans attendre. Mais pour ne rien',
