...
function modeDEmploi(maintenant, contenu) {
  const lignes = [
    ...
    '  Le travail accumulé — reviews, règles, vérificateurs, agents, notes, todos — vit alors',
    '  dans le dépôt git configuré dans Réglages → Données partagées, et c’est LUI qui fait foi.',
    '  Cette archive reste utile : elle porte ce qui n’appartient qu’à ce poste (les jetons y',
    '  sont TOUJOURS retirés), et elle permet de repartir sans attendre. Mais pour ne rien',
    '  perdre d’une équipe, c’est le dépôt de données qu’il faut sauvegarder — la forge s’en',
    '  charge déjà, avec son historique.',
    '',
    'RESTAURER',
