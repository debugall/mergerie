...
const { exigerDossierCompose, startVerifyJob, startJob, startTaskJob, startGitJob, startDockerJob, startConvergeJob, startConvergeSessionJob, startLocalJob, startAskJob, startReconcileJob, startMergeAiJob, startNow, stopJob, isRunning, retryJob } = require('./ordonnanceur');
...
module.exports = { exigerDossierCompose,
  ...
  startLocalJob, startAskJob, startReconcileJob, startMergeAiJob, startNow, stopJob, currentJob, activeJob, runningJobs, queuedJobs, isRunning,
