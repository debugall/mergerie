...
| `jobs/runners/` | un exécutant par sorte de job (`task`, `converge`, `local`, `ask`, `gitops`, `docker`, `reconcile`, `verify`, `review`), inscrit dans le registre au chargement par `jobs/index.js` |
