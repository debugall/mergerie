  ...
  fr: {
    ...
    liens: {
      ...
      slides: [
        ...
        {
          bandeau: 'LIENS',
          titre: 'Liens contextuels et sonde de santé',
          sous: 'Des adresses qui dépendent de la merge request, et un état qu’on n’a pas demandé à surveiller.',
          puces: [
            ...
            'La sonde de santé est désactivée par défaut, environnement par environnement, la prod hors du lot.',
            'HEAD sans lire le corps, 5 s, séquentiel, et seulement quand un onglet est ouvert : pas de trafic la nuit.',
          ],
        },
      ],
    },
  ...
  en: {
    ...
    liens: {
      ...
      slides: [
        ...
        {
          bandeau: 'LINKS',
          titre: 'Contextual links and the health probe',
          sous: 'Addresses that depend on the merge request, and a state you never asked to be watched.',
          puces: [
            ...
            'The health probe is off by default, environment by environment, with production out of the lot.',
            'HEAD with no body read, 5 s, sequential, and only while a tab is open: no phantom traffic at night.',
          ],
        },
      ],
    },
