...
npm pack --dry-run --json 2>/dev/null | node -e '
  let s = ""; process.stdin.on("data", (d) => { s += d; }).on("end", () => {
    ...
    const requis = ["bin/mergerie.js", "src/server.js", "src/db/index.js", "public/index.html", "public/app.js", "public/vendor/mermaid.min.js", "scripts/demo-seed.js", "README.md", "LICENSE"];
